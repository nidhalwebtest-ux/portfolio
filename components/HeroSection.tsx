...
export default function HeroSection() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-[100dvh] lg:h-[100dvh] lg:overflow-hidden w-full bg-[#f8f9fa] flex flex-col justify-between py-6 lg:py-10"
    >
      ...
      {/* 3. BOTTOM SECTION: Chapter Cards */}
